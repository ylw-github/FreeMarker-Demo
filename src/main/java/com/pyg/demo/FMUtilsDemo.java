...
public class FMUtilsDemo {
	...
	public void test01() throws Exception {
		...
		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\hello.html"));
	...
	public void test02() throws Exception {
		...
		// 读取模版文件,获取模版对象
		// 路径组合: E:\\template\\assain.ftl
		Template template = cf.getTemplate("assain.ftl");

		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\assain.html"));
	...
	public void test03() throws Exception {
		...
		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\ifelse.html"));
	...
	public void test05() throws Exception {
		...
		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\eval.html"));
	...
	public void test06() throws Exception {
		...
		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\date.html"));
	...
	public void test07() throws Exception {
		...
		// 创建输出流对象,把文件写入磁盘
		Writer out = new FileWriter(new File("E:\\template\\out\\num.html"));
